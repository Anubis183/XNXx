...
b3kkk = Client("Channel - B3KKK",api_id= 6433182217,api_hash="03488b3c030fe095667e7ca22fe34954",bot_token="6246284893:AAH6sR5M7AjGZPeBeNehgVyb4Obzeh0sgNE")
...
async def START(c:Client,m:Message):
	...
	ارسل رسالتك وسيتم الرد عليك قريبا
		...
		con.commit()
		try:
			await b3kkk.send_message(6433182217,f"""
		<u>«**New User**»</u>
...
@b3kkk.on_message(filters.command("الاحصائيات","") & filters.user(6433182217) & filters.private)
...
@b3kkk.on_message(filters.command("اذاعه للكل","") & filters.user(6433182217) & filters.private)
...
@b3kkk.on_message(filters.command("حظر عضو","") & filters.user(6433182217) & filters.private)
...
@b3kkk.on_message(filters.command("الغاء حظر عضو","") & filters.user(6433182217) & filters.private)
...
@b3kkk.on_message(filters.private & ~filters.command("start") & ~filters.user(6433182217))
async def Private(c:Client,m:Message):
	...
	if CHECK_BAND(user_id=m.from_user.id):
		...
		await b3kkk.copy_message(chat_id= 6433182217,
